defmodule EasyBreezy.Layouts.TitleSlide do
  ...
  def title_slide(assigns) do
    ...
    animate_text_shimmer? = Map.get(assigns.render_context, :animate_text_shimmer?, true)
    ...
    assigns =
      ...
      |> assign(animate_text_shimmer?: animate_text_shimmer?)
    ...
    <box class="grid grid-cols-1 grid-rows-3 width-full height-full">
      ...
      <box style={@title_region_style}>
        ...
        <.h1
          ...
          static_shimmer={!@animate_text_shimmer?}
